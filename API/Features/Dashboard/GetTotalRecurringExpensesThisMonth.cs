...
public class GetTotalRecurringExpensesThisMonthEndpoint : EndpointWithoutRequest<SingleResponse<decimal>>
{
  private readonly IMediator _mediator;

  public GetTotalRecurringExpensesThisMonthEndpoint(IMediator mediator)
  {
    _mediator = mediator;
  }
  ...
  {
    Get("/api/dashboard/total-recurring-expenses-this-month");
    AllowAnonymous();
    Description(d => d
        .WithSummary("Get total recurring expenses for current month")
