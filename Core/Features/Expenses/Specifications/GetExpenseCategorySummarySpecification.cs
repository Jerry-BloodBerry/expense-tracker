...
public class GetExpenseCategorySummarySpecification : BaseSpecification<Expense>
{
  public GetExpenseCategorySummarySpecification(GetExpenseCategorySummaryQuery query)
      : base(e =>
